...
// required string stuff = 1;
inline bool Demo::has_stuff() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Demo::set_has_stuff() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Demo::clear_has_stuff() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Demo::clear_stuff() {
  if (stuff_ != &::google::protobuf::internal::kEmptyString) {
    stuff_->clear();
  }
  clear_has_stuff();
}
inline const ::std::string& Demo::stuff() const {
  return *stuff_;
}
inline void Demo::set_stuff(const ::std::string& value) {
  set_has_stuff();
  if (stuff_ == &::google::protobuf::internal::kEmptyString) {
...
inline void Demo::set_stuff(const char* value) {
  set_has_stuff();
  if (stuff_ == &::google::protobuf::internal::kEmptyString) {
    stuff_ = new ::std::string;
  }
...
inline void Demo::set_stuff(const char* value, size_t size) {
  set_has_stuff();
  if (stuff_ == &::google::protobuf::internal::kEmptyString) {
    stuff_ = new ::std::string;
  }
...
inline ::std::string* Demo::mutable_stuff() {
  set_has_stuff();
  if (stuff_ == &::google::protobuf::internal::kEmptyString) {
    stuff_ = new ::std::string;
  }
...
inline ::std::string* Demo::release_stuff() {
  clear_has_stuff();
  if (stuff_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void Demo::set_allocated_stuff(::std::string* stuff) {
  if (stuff_ != &::google::protobuf::internal::kEmptyString) {
    delete stuff_;
  }
  if (stuff) {
