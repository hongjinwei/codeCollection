...
def main():
    connection = httplib.HTTPConnection('172.16.250.64','2110')
    times = 10
    for i in range(times):
	connection.request('POST','/tanx_bid_request',make_case(),{'Content-type':'application/octet-stream', 'Connection':'keep-alive'})
